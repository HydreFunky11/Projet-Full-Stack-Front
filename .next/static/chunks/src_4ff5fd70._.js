...
const authService = {
    ...
    isAuthenticated () {
        const hasToken = !!(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCookie"])('token') || !!localStorage.getItem('auth_token');
        return hasToken;
    },
    // Connexion
    async login (email, password) {
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])('/users/login', {
                method: 'POST',
                body: {
                    email,
                    password
            ...
            if (response.token) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setCookie"])('token', response.token);
    ...
    async register (username, email, password) {
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])('/users/register', {
                method: 'POST',
                body: {
                    username,
                    email,
    ...
    async logout () {
        try {
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])('/users/logout', {
                    method: 'POST'
                });
            } catch (err) {
            ...
            // Supprimer le token
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["removeCookie"])('token');
            return {
                success: true
            };
        } catch (error) {
    ...
    async getCurrentUser () {
        try {
            ...
            const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCookie"])('token') || localStorage.getItem('auth_token');
            if (!token) {
                console.log('Aucun token trouvé, utilisateur non authentifié');
                return null;
            }
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])('/users/me');
...
function AuthProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            const checkAuth = {
                "AuthProvider.useEffect.checkAuth": async ()=>{
                    try {
                        ...
                        const isLoggedIn = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2f$authService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].isAuthenticated();
                        if (isLoggedIn) {
                            try {
                                const userData = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2f$authService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].getCurrentUser();
                                if (userData) {
                                    setUser(userData);
            ...
            const handleAuthError = {
                "AuthProvider.useEffect.handleAuthError": (message = "Session expirée")=>{
                    // Effacer l'état d'authentification
                    setUser(null);
                    setIsAuthenticated(false);
                    // Nettoyer les cookies et le localStorage
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2f$authService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].logout().catch({
                        "AuthProvider.useEffect.handleAuthError": (err)=>{
                            console.error("Erreur lors de la déconnexion:", err);
                        }
                    }["AuthProvider.useEffect.handleAuthError"]);
                }
            }["AuthProvider.useEffect.handleAuthError"];
            checkAuth();
        }
    ...
    const login = async (email, password)=>{
        try {
            setLoading(true);
            setError(null);
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2f$authService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].login(email, password);
            if (response.user) {
    ...
    const register = async (username, email, password)=>{
        try {
            setLoading(true);
            setError(null);
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2f$authService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].register(username, email, password);
            if (response.user) {
                setUser(response.user);
                setIsAuthenticated(true);
            } else {
    ...
    const logout = async ()=>{
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2f$authService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].logout();
            setUser(null);
            setIsAuthenticated(false);
            router.push('/login');
        } catch (err) {
...
//# sourceMappingURL=src_4ff5fd70._.js.map