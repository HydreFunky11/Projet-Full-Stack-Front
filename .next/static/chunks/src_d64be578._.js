...
const authService = {
    register: async (username, email, password)=>{
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])('/users/register', {
            method: 'POST',
            body: {
                username,
                email,
    ...
    login: async (email, password)=>{
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])('/users/login', {
            method: 'POST',
            body: {
                email,
                password
    ...
    logout: async ()=>{
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])('/users/logout', {
            method: 'POST'
        });
    },
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$authContext$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/contexts/authContext.ts [app-client] (ecmascript)"); // Maintenant ce sera correctement importé
...
//# sourceMappingURL=src_d64be578._.js.map